...
const addClickEventListener = (element, EventFunction) => {
...
const loadApp = setTimeout(() => {
    ...
    var refreshFavorites = document.getElementById('refreshFavorites')
    ...
    addClickEventListener(saveValueButton, () => {
        localStorage.setItem('bm-defaultValue', favoriteFolders.value)
    })

    addClickEventListener(refreshFavorites, () => {
        updateBookMarks()
